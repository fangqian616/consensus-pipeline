...
class PaperCandidate:
    ...
    layer: str = ""  # v0.6.2: QC annotation layer (core/method/background)
...
class AcademicSearchEngine:
    ...
    def __init__(
        ...
        domain_config: Optional[Dict[str, Any]] = None,  # v0.6.2: Dynamic domain configuration
    ):
        """
        Args:
            ...
            domain_config: v0.6.2 dynamic domain config (generated by domain_config_generator)
        """
    ...
    def _apply_four_sieves(
        ...
        for paper in papers:
            ...
            # Stage 4: Content relevance filtering (v5.1 activated, v0.6.2: domain_config driven)
            if query:
    ...
    def _compute_relevance(paper: PaperCandidate, query: str, domain_config: Optional[Dict[str, Any]] = None) -> float:
        ...
        v0.6.2: If domain_config provided, read exclusion_signals and tier_definitions from it,
        ...
        Args:
            ...
            domain_config: v0.6.2 dynamic domain config (optional)
        ...
        # v0.6.2: If domain_config exists, read exclusion signals and tier definitions
        if domain_config:
        ...
        # v0.6.2: Papers matching exclusion_signals return 0.0 directly (not penalty×0.2)
        ...
        # v0.6.2: If no domain_config (fallback mode), keep legacy logic
